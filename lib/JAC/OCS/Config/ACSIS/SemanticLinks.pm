package JAC::OCS::Config::ACSIS::SemanticLinks;
...
This class can be used to parse and modify the ACSIS semantic links
configuration information present in the C<semantic_links> element of an
OCS configuration.

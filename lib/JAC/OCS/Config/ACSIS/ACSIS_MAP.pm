...
JAC::OCS::Config::ACSIS_MAP - Parse and modify OCS ACSIS machine map configurations
...
DOM tree generated by C<XML::LibXML> (i.e. A C<XML::LibXML::Element>).
    ...
    $cfg = new JAC::OCS::Config::ACSIS::ACSIS_MAP(File => $file);
    $cfg = new JAC::OCS::Config::ACSIS::ACSIS_MAP(XML => $xml);
    $cfg = new JAC::OCS::Config::ACSIS::ACSIS_MAP(DOM => $dom);
...
sub tasks {
    ...
    throw JAC::OCS::Config::Error::FatalError(
        "Can not determine task list without a hardware mapping\n")
        unless defined $hw;
